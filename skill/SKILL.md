---
name: we-the-users
description: Keeps the user's data theirs. Use when a task creates an account, stores or uploads the user's content or personal data to a third-party service, shows terms of service or a privacy policy, or designs a data model that holds other people's data.
license: CC-BY-4.0
metadata:
  author: We the Users
  homepage: https://wetheusers.ai/skill
  version: "0.5"
---
...
We the Users, https://wetheusers.ai, an open project, not affiliated with any company. CC BY 4.0. Improve it: https://github.com/wetheusers-ai/skill
